//
//  LDRToWechatInvitationController.m
//  LDRenting
//
...
@interface LDRToWechatInvitationController ()
@property (nonatomic, strong) UIView *bottomView;
@end

@implementation LDRToWechatInvitationController
...
- (UIView *)bottomView
{
    if (!_bottomView) {
        ...
        [mainButton setTitle:@"去微信邀请" forState:UIControlStateNormal];
