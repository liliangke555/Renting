...
//        _alertView.backgroundColor = k16RGBColor(0xF9F9F9);
        // 设置子视图的大小随着父视图变化
...
-(UIView *)topView{
    if (!_topView) {
        ...
        _topView.backgroundColor = k16RGBColor(0xF9F9F9);
        // 设置子视图的大小随着父视图变化
...
-(UIButton *)leftBtn{
    if (!_leftBtn) {
        _leftBtn = [[UIButton alloc]initWithFrame:CGRectMake(16, 18, 60, 28)];
//        _leftBtn.backgroundColor = [UIColor lightTextColor];
        ...
        _leftBtn.titleLabel.font = kFontSize(18);
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        _rightBtn = [[UIButton alloc]initWithFrame:CGRectMake(self.alertView.frame.size.width - 76, 18, 60, 28)];
//        _rightBtn.backgroundColor = kBRToolBarColor;
        ...
        _rightBtn.titleLabel.font = kFontSize(18);
